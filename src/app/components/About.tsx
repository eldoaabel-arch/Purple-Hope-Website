      ...
      <div className="max-w-7xl mx-auto" ref={sectionRef}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20">
          <div style={fadeUp(0.2)}>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              As students in high school, we partnered with Wellspring Cancer Support London to launch Purple Hope, a fundraising campaign dedicated to supporting pancreatic cancer patients and their families. Every dollar raised goes directly to Wellspring's programs and services.
            </p>
          ...
          <div style={fadeUp(0.3)} className="flex flex-col justify-center gap-8">
            ...
            <div className="border-l-4 border-purple-500 pl-6">
              ...
              <p className="text-gray-400 mt-1">most lethal major cancer, with the lowest survival rate of any common cancer</p>
            </div>
            <div className="border-l-4 border-purple-500 pl-6">
