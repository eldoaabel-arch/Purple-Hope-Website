  ...
  return (
    <section id="mission" className="bg-zinc-800 text-white py-24 px-6 md:px-10 scroll-mt-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <h2 className="text-4xl md:text-6xl leading-tight mb-6" style={{ fontFamily: 'var(--font-bebas)' }}>
            Our Goal
          </h2>
        ...
        <div className="mb-12">
          ...
          <div className="w-full bg-zinc-700 rounded-full h-4 md:h-5">
            <div
              className="bg-gradient-to-r from-purple-600 to-blue-400 h-4 md:h-5 rounded-full transition-all duration-700"
              style={{ width: percentage === 0 ? '8px' : `${percentage}%` }}
            />
          </div>
        </div>
